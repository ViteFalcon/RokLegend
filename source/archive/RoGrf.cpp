...
#define roGRF_IMPL_USE_LIBGRF 0

#if roGRF_IMPL_USE_LIBGRF
#   include "libgrf/RoLibGrf2Impl.h"
#   define roGRF_IMPL_CLASS RoLibGrf2Impl
#else
#   include "grf/RoGrf2Impl.h"
#   define roGRF_IMPL_CLASS RoGrf2Impl
#endif

RoGrf2Ptr RoGrf2::FromFile(const RoString& name)
{
    return roGRF_IMPL_CLASS::FromFile(name);
}
