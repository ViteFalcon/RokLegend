...
namespace irrklang
{
    ...
    //--------------------------------------------------------------------------
    class RoNullIrrKlangSound : public ISound
    {
    public:
        static RoNullIrrKlangSound INSTANCE;
        ...
        //! returns if the sound is paused
        virtual bool getIsPaused(){ return false; }
        ...
        virtual ik_f32 getVolume(){ return 0; }
        ...
        virtual ik_f32 getPan(){ return 0; }
        ...
        virtual ik_f32 getMinDistance(){ return 0; }
        ...
        virtual ik_f32 getMaxDistance(){ return 0; }
        ...
        virtual ik_u32 getPlayPosition() { return -1; }
        ...
        virtual ik_f32 getPlaybackSpeed() { return 1.0f; }
        ...
        virtual ISoundEffectControl* getSoundEffectControl() { return nullptr; }
